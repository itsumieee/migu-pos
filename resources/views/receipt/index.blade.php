...
<head>
    ...
    <title>Struk - #{{ str_pad(($transaction->id ?? 0), 5, '0', STR_PAD_LEFT) }}</title>
    ...
    <div id="receipt-content">
        ...
        <div class="header">
            <div class="header-logo">
                {{ \App\Models\Setting::get('store_name') ?? 'MIGU STORE' }}
            </div>
            <p class="header-store">
                {{ \App\Models\Setting::get('store_address') ?? 'Jl. Fashion Modern No. 88, Jakarta' }}
            </p>
            <p class="header-store">
        ...
        <div class="info">
            ...
            <div class="info-row">
                ...
                <span class="info-value">{{ ($transaction->created_at ?? now())->format('d/m/Y H:i') }}</span>
            </div>
            <div class="info-row">
