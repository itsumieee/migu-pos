...
<div class="login-container">
    ...
    <div class="form-side">
        ...
        <h1 class="main-heading">Sign in to your<span>.</span> account</h1>
        ...
        <div class="demo-section">
            ...
            <div class="demo-grid">
                <form action="{{ route('login') }}" method="POST" class="demo-btn" onclick="this.submit()">
                    @csrf
                    <input type="hidden" name="email" value="admin@migu.com">
                    <input type="hidden" name="password" value="admin123">
                    <div class="avatar" style="background: linear-gradient(135deg, #00D4FF, #0099CC); color: #1a1c2e;">A</div>
                    <div class="info">
                        <p>Admin</p>
                ...
                <form action="{{ route('login') }}" method="POST" class="demo-btn" onclick="this.submit()">
                    ...
                    <div class="avatar" style="background: linear-gradient(135deg, #10B981, #059669); color: #1a1c2e;">K</div>
                    <div class="info">
                        <p>Kasir</p>
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <div class="input-group">
                ...
                <input type="email" name="email" value="{{ old('email') }}" placeholder="Enter your email" required class="input-field">
            ...
            <div class="input-group">
                ...
                <input type="password" name="password" id="passwordInput" placeholder="Enter your password" required class="input-field">
                <button type="button" onclick="togglePass()" class="pass-toggle">
...
<style>
        ...
        .demo-section {
            animation: elementSlideIn 0.6s cubic-bezier(0.4, 0, 0.2, 1) 0.3s both;
        }
        ...
        .demo-btn:nth-child(1) {
            animation: elementSlideIn 0.6s cubic-bezier(0.4, 0, 0.2, 1) 0.32s both;
        }
        
        .demo-btn:nth-child(2) {
            animation: elementSlideIn 0.6s cubic-bezier(0.4, 0, 0.2, 1) 0.39s both;
        }
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelector('.login-container').style.animation = 'pageSlideIn 0.6s cubic-bezier(0.4, 0, 0.2, 1) both';
            ...
            if (registerLink) {
                registerLink.addEventListener('click', function(e) {
                    if (!e.ctrlKey && !e.metaKey && !e.shiftKey) {
                        e.preventDefault();
                        document.querySelector('.login-container').style.animation = 'pageSlideIn 0.6s cubic-bezier(0.4, 0, 0.2, 1) reverse forwards';
                        setTimeout(() => {
