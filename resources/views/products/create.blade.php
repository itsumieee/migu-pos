    ...
    <div style="max-width: 900px; margin: 0 auto;">
        ...
        <div class="page-header animate-slide">
            ...
            <div class="page-title-group">
                ...
                <p class="page-subtitle">Isi detail produk dengan lengkap</p>
            </div>
        </div>

        <!-- Form Card -->
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="form-card animate-fade">
            @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="file-upload-wrapper">
                        ...
                        <div class="file-input-wrapper">
                            ...
                            <p class="file-hint">PNG, JPG, WEBP (Max: 2MB)</p>
    ...
    if (skuInput && nameInput && !skuInput.value) {
        nameInput.addEventListener('blur', function() {
            if (!skuInput.value && nameInput.value) {
                // Generate simple SKU: PRD-XXXX
                const randomNum = Math.floor(1000 + Math.random() * 9000);
                skuInput.value = 'PRD-' + randomNum;
            }
        });
    }
    
    // Add smooth scroll to first error on submit
